...
**Useful links**:
`Source Repository <https://github.com/applied-ml-bde/bde>`__ |
`Issues & Ideas <https://github.com/applied-ml-bde/bde/issues>`__ |

This is the documentation for the Bayesian Deep Ensembles module.
